...
contract Vault {
    ...
    //Fallback function to accept ETH rewards sent directly to the contract. Any ETH sent to this contract's address without data will be accepted
    receive() external payable {}

    //Allows users to deposit ETH into the vault and mint rebase tokens in return
